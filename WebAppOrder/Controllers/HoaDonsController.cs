...
namespace WebAppOrder.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHD,MaKH,MaNV,NgayLapHD,TongTien")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHD,MaKH,MaNV,NgayLapHD,TongTien")] HoaDon hoaDon)
        {
            if (ModelState.IsValid)
            {
